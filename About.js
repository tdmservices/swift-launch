...
// ==========================================
// 1. 3D TILT EFFECT — REMOVED
// ==========================================
// (mousemove tilt aur card rotation completely hataya)

// ==========================================
// 2. THREE.JS GLOBE — REMOVED
// ==========================================
// (particle animation, renderer, scene sab hataya)
...
closeBtn.addEventListener('click', () => {
  ...
  // card.style.transform removed — no animation
});
...
window.addEventListener('load', () => {
  // Three.js initThreeEngine() — REMOVED
  // animateThree() — REMOVED
  // Auto-open setTimeout — REMOVED (agar chahiye to manually open hoga button se)
});
